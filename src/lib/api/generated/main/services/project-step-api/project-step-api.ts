...
export const getProjectAuthorization = (
 ...
 signal?: AbortSignal
      ...
      return mainAxios<GetProjectAuthorizationResponse>(
      {url: `/api/projects/steps/${stepId}/authorizations`, method: 'GET', signal
    },
      );
    }
  

export const getGetProjectAuthorizationQueryKey = (stepId: number,) => {
    return [`/api/projects/steps/${stepId}/authorizations`] as const;
    }

    
export const getGetProjectAuthorizationInfiniteQueryOptions = <TData = InfiniteData<Awaited<ReturnType<typeof getProjectAuthorization>>>, TError = unknown>(stepId: number, options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof getProjectAuthorization>>, TError, TData>>, }
) => {

const {query: queryOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetProjectAuthorizationQueryKey(stepId);

  

    const queryFn: QueryFunction<Awaited<ReturnType<typeof getProjectAuthorization>>> = ({ signal }) => getProjectAuthorization(stepId, signal);

      

      

   return  { queryKey, queryFn, enabled: !!(stepId), ...queryOptions} as UseInfiniteQueryOptions<Awaited<ReturnType<typeof getProjectAuthorization>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function useGetProjectAuthorizationInfinite<TData = InfiniteData<Awaited<ReturnType<typeof getProjectAuthorization>>>, TError = unknown>(
 stepId: number, options: { query:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof getProjectAuthorization>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
...
export function useGetProjectAuthorizationInfinite<TData = InfiniteData<Awaited<ReturnType<typeof getProjectAuthorization>>>, TError = unknown>(
 stepId: number, options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof getProjectAuthorization>>, TError, TData>>, }
...
export function useGetProjectAuthorizationInfinite<TData = InfiniteData<Awaited<ReturnType<typeof getProjectAuthorization>>>, TError = unknown>(
 stepId: number, options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof getProjectAuthorization>>, TError, TData>>, }
  ...
  const queryOptions = getGetProjectAuthorizationInfiniteQueryOptions(stepId,options)
...
export const getGetProjectAuthorizationQueryOptions = <TData = Awaited<ReturnType<typeof getProjectAuthorization>>, TError = unknown>(stepId: number, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getProjectAuthorization>>, TError, TData>>, }
) => {
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetProjectAuthorizationQueryKey(stepId);
   ...
   return  { queryKey, queryFn, enabled: !!(stepId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getProjectAuthorization>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function useGetProjectAuthorization<TData = Awaited<ReturnType<typeof getProjectAuthorization>>, TError = unknown>(
 stepId: number, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof getProjectAuthorization>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof getProjectAuthorization>>,
          TError,
          Awaited<ReturnType<typeof getProjectAuthorization>>
...
export function useGetProjectAuthorization<TData = Awaited<ReturnType<typeof getProjectAuthorization>>, TError = unknown>(
 stepId: number, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getProjectAuthorization>>, TError, TData>>, }
...
export function useGetProjectAuthorization<TData = Awaited<ReturnType<typeof getProjectAuthorization>>, TError = unknown>(
 stepId: number, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getProjectAuthorization>>, TError, TData>>, }
  ...
  const queryOptions = getGetProjectAuthorizationQueryOptions(stepId,options)
...
export const postProjectAuthorization = (
 ...
 signal?: AbortSignal
      ...
      return mainAxios<PostProjectAuthorizationResponse>(
      {url: `/api/projects/steps/${stepId}/authorizations`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
      data: postProjectAuthorizationRequest, signal
    },
      );
    }
...
export const getPostProjectAuthorizationMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postProjectAuthorization>>, TError,{stepId: number;data: PostProjectAuthorizationRequest}, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof postProjectAuthorization>>, TError,{stepId: number;data: PostProjectAuthorizationRequest}, TContext> => {
...
const {mutation: mutationOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postProjectAuthorization>>, {stepId: number;data: PostProjectAuthorizationRequest}> = (props) => {
          const {stepId,data} = props ?? {};

          return  postProjectAuthorization(stepId,data,)
        }
...
export const usePostProjectAuthorization = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postProjectAuthorization>>, TError,{stepId: number;data: PostProjectAuthorizationRequest}, TContext>, }
        ...
        TError,
        {stepId: number;data: PostProjectAuthorizationRequest},
        TContext
      > => {
